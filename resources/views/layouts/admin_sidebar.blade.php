<div class="sidebar-category sidebar-category-visible">
  <div class="category-content no-padding">
    <ul class="navigation navigation-main navigation-accordion">
      ...
      <li class="active"><router-link to="/"><i class="icon-home4"></i> <span>Dashboard</span></router-link></li>
      <li>
     ...
     <li>
      ...
      <li>
        <a href="#"><i class="icon-stack2"></i> <span>Nurse</span></a>
          <ul>
            <li><router-link to="/nurse_add">Add Nurse</router-link></li>
            <li><router-link to="/nurse_list">Nurse List</router-link></li>
          </ul>
      </li>
      ...
      <li>
        <a href="#"><i class="icon-stack2"></i> <span>Account</span></a>
          <ul>
            <li><router-link to="/account">Add Accountant</router-link></li>
            <li><router-link to="/account_list">Accountant List</router-link></li>
          </ul>
      </li>
