  ...
  <div class="add_users">
    ...
    <div class="panel panel-flat">
      ...
      <div class="panel-body">
        <form @submit.prevent="AddNewLaboratorist">
            ...
            <div class="form-group">
              <div class="col-md-12">
                <div class="row">
                  ...
                  <div class="col-md-11">
                    <input type="text"  class="form-control" v-model="AddLaboratorist.users_name" placeholder="Name" >
              ...
              <!-- <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="text" class="form-control" v-model="AddLaboratorist.guardian_name" placeholder="Enter Guardian Name" >
            ...
            <div class="form-group">
              <div class="col-md-12">
                <div class="row">
                  ...
                  <div class="col-md-11">
                    <textarea class="form-control" v-model="AddLaboratorist.address" placeholder="Enter Address"></textarea>
            ...
            <div class="form-group">
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="text" class="form-control" v-model="AddLaboratorist.phone" placeholder="Enter Phone Number" >
              ...
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <select  class="form-control" v-model="AddLaboratorist.sex">
            ...
            <div class="form-group">
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <select  class="form-control" v-model="AddLaboratorist.shift_id">
                      <option value="">Select</option>
              ...
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input class="form-control" v-model="AddLaboratorist.working_hours" type="number">
            ...
            <div class="form-group">
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="date" v-model="AddLaboratorist.birth_date" class="form-control" placeholder="Enter Birth Date" >
              ...
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="number" class="form-control" v-model="AddLaboratorist.age" placeholder="Enter Age" >
            ...
            <div class="form-group">
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <select  class="form-control" v-model="AddLaboratorist.blood_group">
                      <option value="">Select</option>
                      <option>O−</option>
                      <option>O+</option>
                      <option>A−</option>
            ...
            <div class="form-group">
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <select class="form-control" v-model="AddLaboratorist.status">
                        <option value=''>Select</option>
            ...
            <div class="form-group">
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="text"  v-model="AddLaboratorist.email" class="form-control" placeholder="Enter Email" >
            ...
            <div class="form-group">
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="password" v-model="AddLaboratorist.password"  class="form-control" placeholder="Enter Password" >

                    <span class="text-warning" v-if="(AddLaboratorist.password && AddLaboratorist.password.length ? AddLaboratorist.password.length : 0) == 0"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i>&nbsp;Password Is Empty</span>
                     <span class="text-danger" v-else-if="(AddLaboratorist.password && AddLaboratorist.password.length ? AddLaboratorist.password.length : 0) < 8"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i>&nbsp;Password Is Weak</span>
              ...
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    ...
                    <span class="text-danger" v-if="confirm_password.length !=0 &&  AddLaboratorist.password && AddLaboratorist.password.length !=0 && AddLaboratorist.password != confirm_password"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i>&nbsp;Password Not Mactched</span>
                     <span class="text-success" v-else-if="AddLaboratorist.password && AddLaboratorist.password.length !=0 && AddLaboratorist.password == confirm_password"><i class="fa fa-check-circle" aria-hidden="true"></i>&nbsp;Password Matched</span>
    ...
    export default{
       ...
       methods:{
         ImageGet:function(event){
            ...
            this.LoadingStatus();
            reader.onload=event =>{
              this.AddLaboratorist.image = event.target.result;
              this.image_source=event.target.result;
            }
              reader.readAsDataURL(file)
          },
          AddNewLaboratorist:function(){
              const _this=this;
              axios.post(this.baseUrl+'laboratorist',_this.AddLaboratorist)
              .then((response)=>{
          ...
          GetData:function(){
              const _this=this;
              axios.get(this.baseUrl+'laboratorist/create',_this.AddLaboratorist)
              .then((response)=>{
          ...
          resetForm() {
              var _this = this;
              var FORM = _this.AddLaboratorist;
              Object.keys(FORM).forEach(function (key, index) {
                  FORM[key] = '';
              });
              _this.AddLaboratorist.type = '8';
              _this.Errors=[];
              image_source:'';
          },
