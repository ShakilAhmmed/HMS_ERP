  ...
  <div class="add_users">
    ...
    <div class="panel panel-flat">
      ...
      <div class="panel-body">
        <form @submit.prevent="EditLaboratoristData">
          <fieldset class="content-group">
            <form class="form-horizontal">
            <legend class="text-bold">Add New Laboratorist</legend>
            <div class="form-group">
              <div class="col-md-12">
                <div class="row">
                  <label class="col-lg-1 control-label">Name:</label>
                  <div class="col-md-11">
                    <input type="text"  class="form-control" v-model="EditLaboratorist.users_name" placeholder="Name" >
              ...
              <!-- <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="text" class="form-control" v-model="EditLaboratorist.guardian_name" placeholder="Enter Guardian Name" >
            ...
            <div class="form-group">
              <div class="col-md-12">
                <div class="row">
                  ...
                  <div class="col-md-11">
                    <textarea class="form-control" v-model="EditLaboratorist.address" placeholder="Enter Address"></textarea>
            ...
            <div class="form-group">
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="text" class="form-control" v-model="EditLaboratorist.phone" placeholder="Enter Phone Number" >
              ...
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <select  class="form-control" v-model="EditLaboratorist.sex">
            ...
            <div class="form-group">
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <select  class="form-control" v-model="EditLaboratorist.shift_id">
                      <option value="">Select</option>
              ...
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input class="form-control" v-model="EditLaboratorist.working_hours" type="number">
            ...
            <div class="form-group">
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="date" v-model="EditLaboratorist.birth_date" class="form-control" placeholder="Enter Birth Date" >
              ...
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="text" class="form-control" v-model="EditLaboratorist.age" placeholder="Enter Age" >
            ...
            <div class="form-group">
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <select  class="form-control" v-model="EditLaboratorist.blood_group">
                      <option value="">Select</option>
                      <option>O−</option>
                      <option>O+</option>
                      <option>A−</option>
            ...
            <div class="form-group">
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <select class="form-control" v-model="EditLaboratorist.status">
                        <option value=''>Select</option>
            ...
            <div class="form-group">
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="text"  v-model="EditLaboratorist.email" class="form-control" placeholder="Enter Email" >
            ...
            <div class="form-group">
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="password" v-model="EditLaboratorist.password"  class="form-control" placeholder="Enter Password" >

                    <span class="text-warning" v-if="(EditLaboratorist.password && EditLaboratorist.password.length ? EditLaboratorist.password.length : 0) == 0"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i>&nbsp;Password Is Empty</span>
                     <span class="text-danger" v-else-if="(EditLaboratorist.password && EditLaboratorist.password.length ? EditLaboratorist.password.length : 0) < 8"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i>&nbsp;Password Is Weak</span>
              ...
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    ...
                    <span class="text-danger" v-if="confirm_password.length !=0 &&  EditLaboratorist.password && EditLaboratorist.password.length !=0 && EditLaboratorist.password != confirm_password"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i>&nbsp;Password Not Mactched</span>
                     <span class="text-success" v-else-if="EditLaboratorist.password && EditLaboratorist.password.length !=0 && EditLaboratorist.password == confirm_password"><i class="fa fa-check-circle" aria-hidden="true"></i>&nbsp;Password Matched</span>
    ...
    export default{
       ...
       methods:{
         ImageGet:function(event){
            ...
            this.LoadingStatus();
            reader.onload=event =>{
              this.EditLaboratorist.image = event.target.result;
              this.image_source=event.target.result;
            }
              reader.readAsDataURL(file)
          },
          EditLaboratoristData:function(){
              const _this=this;
              axios.put(this.baseUrl+'laboratorist/'+_this.EditLaboratorist.users_id,_this.EditLaboratorist)
              .then((response)=>{
                  console.log(response.data);
                  if(response.data.status===201){
                     this.$toastr.success('Laboratorist Edit Added Successfully', 'Success');
                     this.LoadingStatus();
                     _this.GetData();
                  }
                  else{
          ...
          GetData:function(){
              const _this=this;
              axios.get(this.baseUrl+'laboratorist/'+this.$route.params.laboratorist_id+'/edit',_this.EditLaboratorist)
              .then((response)=>{
                _this.Shift = response.data.shift;
                _this.EditLaboratorist = response.data.user;
