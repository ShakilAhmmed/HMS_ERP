          ...
          <tbody>
            <tr v-for="(test_category_list,index) in TestCategoryList.data">
              ...
              <td class="text-center">
                  ...
                  <button class="btn btn-info" data-toggle="modal" data-target="#editModal"  @click="EditTestCategory(test_category_list.test_category_id,test_category_list)">
...
<script>
    export default{
      ...
      methods:{
        ...
        EditTestCategory:function(id,data)
        {
          const _this=this;
